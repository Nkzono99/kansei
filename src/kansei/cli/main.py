...
from kansei.cli.commands import backup, dashboard, delegate, init, mcp, project, provider
from kansei.cli.commands import doctor as doctor_command
from kansei.cli.commands import migrate as migrate_command
...
app.command()(migrate_command.migrate)
